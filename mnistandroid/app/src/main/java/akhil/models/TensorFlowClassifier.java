...
public class TensorFlowClassifier implements com.akhil.models.Classifier {
   ...
   //given a model, its label file, and its metadata
    ...
    @Override
    public com.akhil.models.Classification recognize(final float[] pixels) {
        ...
        com.akhil.models.Classification ans = new com.akhil.models.Classification();
